...
<body>
    ...
    <?php
        if(isset($_POST["lawyer-signup"])){
            ...
            $category=($_POST["lawyer-category"]);
            ...
            if ($con) {
                ...
                if ($numRows > 0) {
                    ...
                    $stmt = $con->prepare("INSERT INTO lawyer_login(lawyer_first_name, lawyer_last_name, lawyer_email, lawyer_password,lawyer_category)
                    VALUES (?,?,?,?,?)");
                    $stmt->bind_param('sssss', $firstname, $lastname, $email, $hashedpwd, $category);
                    $stmt->execute();
    ...
    <form action="lawyer_signup.php" method="post" style="border:1px solid #ccc">
        <div class="container">
            ...
            <input type="text" placeholder="Enter Category" name="lawyer-category" required>
