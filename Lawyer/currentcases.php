...
if ($con) {
	$x = 1;
	$stmt = $con->prepare("SELECT case_id, case_type, case_details, next_hearing_date, prev_hearing_date, court_name FROM cases WHERE lawyer_id_assigned = ? AND case_status != 'rejected'");
	$status = "pending";
